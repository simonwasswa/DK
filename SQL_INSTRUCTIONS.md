# How to Run SQL in Your Supabase Project

## Quick Video Steps:

### Step 1: Go to Supabase Dashboard
- URL: https://supabase.com/dashboard/project/pcquwfdzdogfinrsfpgj
- Sign in if needed

### Step 2: Click "SQL Editor" (Left Sidebar)
Look for the icon that looks like `{ }`

### Step 3: Click "New Query" (Top Right)
A blank SQL editor will appear

### Step 4: Copy This Entire SQL Code:

```sql
-- DK Car Modification - Database Schema
...
2. Ctrl+A to select all (if there's existing text)
3. Paste the SQL code (Ctrl+V)

### Step 6: Click "Run" (or press Ctrl+Enter)
**Wait** for the query to complete - you'll see a success message
...
Your database is now set up. Go back and test:

```bash
npm run dev
# Visit your site and test the Contact Form and Booking Modal
```

---

**Questions?** See SUPABASE_SETUP.md for more details